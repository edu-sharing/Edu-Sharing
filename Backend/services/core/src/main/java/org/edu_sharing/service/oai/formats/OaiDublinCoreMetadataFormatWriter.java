...
public class OaiDublinCoreMetadataFormatWriter extends AbstractMetadataFormatWriter {
    ...
    public void build(Context context) throws ParserConfigurationException {
        ...
        context.createAndAppendElement("dc:contributor", root, prepareContributor(context, propertyMapper.getStringList(CCConstants.CCM_PROP_IO_REPL_LIFECYCLECONTRIBUTER_SCRIPT_WRITER), "Publisher"));
        context.createAndAppendElement("dc:contributor", root, prepareContributor(context, propertyMapper.getStringList(CCConstants.CCM_PROP_IO_REPL_LIFECYCLECONTRIBUTER_SUBJECT_MATTER_EXPERT),  "Script Writer"));
