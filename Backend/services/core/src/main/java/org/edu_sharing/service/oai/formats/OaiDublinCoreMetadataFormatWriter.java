...
public class OaiDublinCoreMetadataFormatWriter extends AbstractMetadataFormatWriter {
    ...
    public void build(Context context) throws ParserConfigurationException {
        ...
        context.createAndAppendElement("dc:creator", root, prepareContributor(context, propertyMapper.getStringList(CCConstants.CCM_PROP_IO_REPL_METADATACONTRIBUTER_CREATOR)));
        context.createAndAppendElement("dc:publisher", root, prepareContributor(context, propertyMapper.getStringList(CCConstants.CCM_PROP_IO_REPL_LIFECYCLECONTRIBUTER_PUBLISHER)));
        ...
        context.createAndAppendElement("dc:contributor", root, prepareContributor(context, propertyMapper.getStringList(CCConstants.CCM_PROP_IO_REPL_LIFECYCLECONTRIBUTER_AUTHOR)));
        context.createAndAppendElement("dc:contributor", root, prepareContributor(context, propertyMapper.getStringList(CCConstants.CCM_PROP_IO_REPL_LIFECYCLECONTRIBUTER_CONTENT_PROVIDER)));
        context.createAndAppendElement("dc:contributor", root, prepareContributor(context, propertyMapper.getStringList(CCConstants.CCM_PROP_IO_REPL_LIFECYCLECONTRIBUTER_EDITOR)));
        context.createAndAppendElement("dc:contributor", root, prepareContributor(context, propertyMapper.getStringList(CCConstants.CCM_PROP_IO_REPL_LIFECYCLECONTRIBUTER_EDUCATIONAL_VALIDATOR)));
        context.createAndAppendElement("dc:contributor", root, prepareContributor(context, propertyMapper.getStringList(CCConstants.CCM_PROP_IO_REPL_LIFECYCLECONTRIBUTER_GRAPHICAL_DESIGNER)));
        context.createAndAppendElement("dc:contributor", root, prepareContributor(context, propertyMapper.getStringList(CCConstants.CCM_PROP_IO_REPL_LIFECYCLECONTRIBUTER_INITIATOR)));
        context.createAndAppendElement("dc:contributor", root, prepareContributor(context, propertyMapper.getStringList(CCConstants.CCM_PROP_IO_REPL_LIFECYCLECONTRIBUTER_INSTRUCTIONAL_DESIGNER)));
        context.createAndAppendElement("dc:contributor", root, prepareContributor(context, propertyMapper.getStringList(CCConstants.CCM_PROP_IO_REPL_LIFECYCLECONTRIBUTER_SCRIPT_WRITER)));
        context.createAndAppendElement("dc:contributor", root, prepareContributor(context, propertyMapper.getStringList(CCConstants.CCM_PROP_IO_REPL_LIFECYCLECONTRIBUTER_SUBJECT_MATTER_EXPERT)));
        context.createAndAppendElement("dc:contributor", root, prepareContributor(context, propertyMapper.getStringList(CCConstants.CCM_PROP_IO_REPL_LIFECYCLECONTRIBUTER_TECHNICAL_IMPLEMENTER)));
        context.createAndAppendElement("dc:contributor", root, prepareContributor(context, propertyMapper.getStringList(CCConstants.CCM_PROP_IO_REPL_LIFECYCLECONTRIBUTER_TECHNICAL_VALIDATOR)));
        context.createAndAppendElement("dc:contributor", root, prepareContributor(context, propertyMapper.getStringList(CCConstants.CCM_PROP_IO_REPL_LIFECYCLECONTRIBUTER_TERMINATOR)));
        context.createAndAppendElement("dc:contributor", root, prepareContributor(context, propertyMapper.getStringList(CCConstants.CCM_PROP_IO_REPL_LIFECYCLECONTRIBUTER_VALIDATOR)));
